...
--- 
<!-- # Eimhin Rafferty -->
Lecco, Italy • +393792058117 • eimhin@pm.me • [case studies](http://www.eimhin.co/pm-portfolio) • [linkedin/eimhin](https://www.linkedin.com/in/eimhin-rafferty)

## Professional Experience

### Archilogic • Product Manager • *11/2022 - 05/2024*  

- Managed product roadmap for Editor, Data Services, and Customer Onboarding verticals. Defined, gathered and analyzed metrics to drive decision-making and inform OKRs.
...
### WeWork • Product Manager, Design Technology • *07/2018 - 11/2022*

- Conducted major pricing analysis initiative, designing and validating a new pricing model using a dataset of 130k inventory rooms and 100k inventory items, with deep data drien insights reported to c-suite via tableau. 
- Technical Manager delivering the "Record Model Initiative," a $2.7M project to deliver uniform, verified real estate data, significantly informing key business metrics.
...
- Led a practice-wide digital transformation from CAD workflows to fully BS:1192 compliant BIM workflows in an ISO 9001/27001 accredited firm.
...
- **Technical Skills**: Product Lifecycle Management, Market Research, Agile Methodologies, Project Management, Data Analysis, Product Roadmapping, User Experience (UX) Design, Wireframing and Prototyping, Digital Tranformation
- **Soft Skills**: Communication, Leadership, Strategic Thinking, Problem-Solving, Customer Focus, Data Driven Decision-Making, Collaboration
- **Tools and Software**: Python, SQL, Tableau, Looker, Typescript, Jira, Linear, Figma, Monday.com, Miro, Lucidchart, Lookback, Google Analytics, Mixpanel, HubSpot, Slack, Excel, Postman, Notion, Retool
